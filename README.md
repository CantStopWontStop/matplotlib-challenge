...
[Module 5 Challenge filesLinks to an external site.](https://static.bc-edx.com/data/dl-1-1/m5/lms/starter/module_5_starter_code.zip)
...
**hint**: All four box plots should be within the same figure. Use this [Matplotlib documentation pageLinks to an external site.](https://matplotlib.org/gallery/pyplots/boxplot_demo_pyplot.html#sphx-glr-gallery-pyplots-boxplot-demo-pyplot-py) for help with changing the style of the outliers.
